...
export default function form_avai() {
  return (
    <>
      <form className="form1">
  <div className="mb-4 text-start ">
    <label htmlFor="check-loc" className="form-label">Location:</label>
    <input type="text" className="form-control" id="check-loc" placeholder="Enter your Location"aria-describedby="emailHelp"/>
  ...
  <button type="submit" className="btn btn primary">Check Availibity</button>
</form>
    </>
  )
}
